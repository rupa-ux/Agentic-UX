...
export function SharedByMe({ onEditDraft, onViewReport }: SharedByMeProps) {
  ...
  return (
    <div className="flex-1 bg-[#f8f9fa] overflow-auto">
      {/* Header */}
      <div className="bg-[#f8f9fa] px-8 pt-5 pb-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-[22px] text-[#212121] tracking-[-0.26px]" style={{ fontWeight: 400 }}>Shared by me</h1>
          </div>
          <div className="flex items-center gap-[3px]">
            {/* All time */}
            <button className="flex items-center gap-2 px-4 py-2 border border-[#e5e9f0] rounded-[10px] bg-white text-[13px] text-[#212121] hover:bg-[#f5f5f5] transition-colors" style={{ fontWeight: 400 }}>
            ...
            <div className="relative" ref={statusDropdownRef}>
              <button
                ...
                className="flex items-center gap-2 px-3.5 py-2 border border-[#e5e9f0] rounded-[10px] bg-white text-[13px] text-[#555] hover:bg-[#f5f5f5] transition-colors"
              ...
              {statusDropdownOpen && (
                <div className="absolute right-0 top-full mt-1 bg-white rounded-lg shadow-lg border border-[#e5e9f0] py-1 z-50 min-w-[140px]">
                  {(["all", "active", "expired", "revoked"] as const).map(s => (
                    <button
                      key={s}
                      onClick={() => { setStatusFilter(s); setStatusDropdownOpen(false); }}
                      className={`w-full text-left px-3 py-1.5 text-[13px] hover:bg-[#f5f5f5] ${statusFilter === s ? "text-[#2552ED]" : "text-[#212121]"}`}
            ...
            <div className="relative" ref={typeDropdownRef}>
              ...
              {typeDropdownOpen && (
                <div className="absolute right-0 top-full mt-1 bg-white rounded-lg shadow-lg border border-[#e5e9f0] py-1 z-50 min-w-[180px]">
                  <button
                    onClick={() => { setTypeFilter("all"); setTypeDropdownOpen(false); }}
                    className={`w-full text-left px-3 py-1.5 text-[13px] hover:bg-[#f5f5f5] ${typeFilter === "all" ? "text-[#2552ED]" : "text-[#212121]"}`}
                  ...
                  {(Object.keys(reportTypeLabels) as ReportType[]).map(t => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-1.5 text-[13px] hover:bg-[#f5f5f5] ${typeFilter === t ? "text-[#2552ED]" : "text-[#212121]"}`}
      ...
      <div className="px-8 pb-4">
        <div className="grid grid-cols-4 gap-4">
          {/* Active shares */}
          <div className="bg-white rounded-[14px] px-5 pt-5 pb-4 flex items-start gap-4">
            ...
            <div>
              <p className="text-[26px] text-[#212121] tracking-[0.22px]" style={{ fontWeight: 400 }}>{totalActive}</p>
              <p className="text-[12px] text-[#999] mt-0.5">Active shares</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[14px] px-5 pt-5 pb-4 flex items-start gap-4">
            ...
            <div>
              <p className="text-[26px] text-[#212121] tracking-[0.22px]" style={{ fontWeight: 400 }}>{totalViews}</p>
              <p className="text-[12px] text-[#999] mt-0.5">Total views</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[14px] px-5 pt-5 pb-4 flex items-start gap-4">
            ...
            <div>
              <p className="text-[26px] text-[#212121] tracking-[0.22px]" style={{ fontWeight: 400 }}>{totalUniqueViewers}</p>
              <p className="text-[12px] text-[#999] mt-0.5">Unique viewers</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[14px] px-5 pt-5 pb-4 flex items-start gap-4">
            ...
            <div>
              <p className="text-[26px] text-[#212121] tracking-[0.22px]" style={{ fontWeight: 400 }}>{totalDownloads}</p>
              <p className="text-[12px] text-[#999] mt-0.5">Downloads</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {drafts.length > 0 && (
        <div className="px-8 pb-4">
          <div className="bg-white rounded-[14px] overflow-hidden">
            <div className="px-5 py-3.5 border-b border-[#e5e9f0] flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-[#FF9800]" />
                <span className="text-[14px] text-[#212121]" style={{ fontWeight: 400 }}>Drafts</span>
                <span className="text-[12px] text-[#999] ml-1">{drafts.length} unsent {drafts.length === 1 ? "report" : "reports"}</span>
              </div>
            </div>
            <div className="divide-y divide-[#e5e9f0]">
              {drafts.map((draft) => (
                <div
                  key={draft.id}
                  className="flex items-center gap-4 px-5 py-3.5 hover:bg-[#fafbfc] transition-colors group"
                >
                  {/* Draft icon */}
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] text-[#212121] truncate" style={{ fontWeight: 400 }}>{draft.reportName}</p>
                  ...
                  <div className="flex items-center gap-1.5 mr-2">
                    ...
                    <span className="text-[11px] text-[#999]">{draft.selectedFont}</span>
                  </div>
      ...
      <div className="px-8 pb-6">
        <div className="bg-white rounded-[14px] overflow-hidden">
          {/* Search bar */}
          <div className="px-5 py-3.5 border-b border-[#e5e9f0] flex items-center gap-3">
            <div className="flex-1 flex items-center gap-2 px-3.5 py-2 bg-[#f8f9fa] border border-[#e5e9f0] rounded-[10px]">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-[13px] text-[#212121] placeholder:text-[#bbb] outline-none"
              />
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[1200px]">
              ...
              <tbody>
                {filtered.map((item) => (
                  <tr key={item.id} className="border-b border-[#e5e9f0] hover:bg-[#fafbfc] transition-colors group">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-1 min-w-0">
                          <p className="text-[13px] text-[#212121] truncate" style={{ fontWeight: 400 }}>{item.reportName}</p>
                          <div className="flex items-center gap-2">
                            <span
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-col gap-0.5">
                        ...
                        <p className="text-[11px] text-[#999] truncate max-w-[160px]">{item.sharedWith[0]}</p>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-col gap-0.5">
                        <p className="text-[13px] text-[#212121]">{formatRelativeDate(item.sharedAt)}</p>
                        <p className="text-[11px] text-[#999]">{formatDate(item.sharedAt)}</p>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-col gap-1">
                        ...
                        {item.expiresAt && (
                          <p className="text-[10px] text-[#999] pl-0.5">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-col gap-0.5">
                        <div className="flex items-center gap-1">
                          <Eye className="w-3.5 h-3.5 text-[#bbb]" />
                          <span className="text-[13px] text-[#212121]" style={{ fontWeight: 400 }}>{item.accessCount}</span>
                        </div>
                        <p className="text-[11px] text-[#999]">{item.uniqueViewers} unique</p>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-col gap-0.5">
                        ...
                        {item.lastAccessedBy && (
                          <p className="text-[11px] text-[#999] truncate max-w-[160px]">
                    ...
                    <td className="px-4 py-4 relative">
                      <div ref={actionMenuId === item.id ? actionMenuRef : undefined}>
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-[#f0f0f0] transition-colors"
                        >
                          <MoreHorizontal className="w-4 h-4 text-[#999]" />
                        </button>
                        {actionMenuId === item.id && (
                          <div className="absolute right-4 top-full mt-1 bg-white rounded-lg shadow-lg border border-[#e5e9f0] py-1 z-50 min-w-[180px]">
                            {/* Copy link */}
                            <button
                              className="w-full text-left px-3 py-2 text-[13px] text-[#212121] hover:bg-[#f5f5f5] flex items-center gap-2.5"
                              onClick={() => {
                            ...
                            >
                              <Printer className="w-3.5 h-3.5 text-[#777]" />
                              Print
                            </button>
                            ...
                            >
                              <RotateCcw className="w-3.5 h-3.5 text-[#777]" />
                              Reshare
                            </button>

                            <div className="border-t border-[#e5e9f0] my-1" />
        ...
        return (
          <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-[100]" onClick={() => setConfirmDeleteId(null)}>
            <div className="bg-white rounded-2xl shadow-2xl p-6 w-[380px]" onClick={e => e.stopPropagation()}>
              <h3 className="text-[16px] text-[#212121] mb-2" style={{ fontWeight: 400 }}>Delete shared report?</h3>
              ...
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className="px-4 py-2 text-[13px] text-[#555] hover:bg-[#f5f5f5] rounded-lg transition-colors"
                  style={{ fontWeight: 400 }}
                >
                  Cancel
                </button>
