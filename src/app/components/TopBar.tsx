  ...
  return (
    <div className="h-[56px] bg-[#e0e5eb] dark:bg-[#181b22] flex items-center justify-between px-4 shrink-0 transition-colors duration-300 rounded-tr-lg" data-no-print>
      ...
      <p className="text-[16px] text-[#212121] dark:text-[#e4e4e4] tracking-[-0.31px]" style={{ fontWeight: 400 }}>
        {currentView === "business-overview" ? "Business overview" : currentView === "inbox" ? "Inbox" : currentView === "storybook" ? "Component showcase" : currentView === "reviews" ? "Reviews" : currentView === "social" ? "Social AI" : currentView === "searchai" ? "Search AI" : currentView === "contacts" ? "Contacts" : currentView === "scheduled-deliveries" ? "Scheduled deliveries" : currentView === "agents" ? "Myna AI" : currentView === "agents-monitor" ? "Myna AI" : currentView === "agents-builder" ? "Myna AI" : currentView === "agents-onboarding" ? "BirdAI setup" : currentView === "agent-detail" ? "Myna AI" : currentView === "schedule-builder" ? "Scheduled deliveries" : currentView === "birdai-reports" ? "Myna AI" : "Reports"}
      </p>
